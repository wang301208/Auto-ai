...
async def run_async_interaction_loop(
    ...
    Replaces the sync while-loop in autogpt/app/main.py with an
    ...
    while cycles_remaining > 0:
        ...
        try:
            ...
            from autogpt.agents.async_agent import CommandRepetitionError
        ...
        if multi_tui is not None:
            try:
                from autogpt.app.multi_agent_tui import AgentViewData
