...
class AsyncAgent(BaseAgent):
    ...
    async def async_execute_step(
        ...
        if self._sandbox is not None and command_name is not None:
            from autogpt.sandbox.base import ViolationType
    ...
    async def _routed_chat_completion(self, prompt: ChatSequence) -> Any:
        ...
        from autogpt.llm.model_router.base_provider import ChatMessage
        ...
        try:
            ...
            from autogpt.llm.base import ChatModelInfo, ChatModelResponse, ModelInfo
