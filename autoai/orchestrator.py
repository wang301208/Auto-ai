...
"""Simple orchestrator that starts core AutoAI agents."""
...
from autoai.agents import Archaeologist, QAAgent, SentryAgent, TDDDeveloper
from autoai.dashboard import run_dashboard
