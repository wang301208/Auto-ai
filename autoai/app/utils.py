...
def clean_input(config: Config, prompt: str = "", talk: bool = False) -> str:
    try:
        ...
        logger.info(_("You interrupted Auto-AI"))
...
def get_latest_bulletin() -> tuple[str, bool]:
    ...
    news_header = Fore.YELLOW + _("Welcome to Auto-AI!\n")
    if new_bulletin or current_bulletin:
        news_header += _(
            "Below you'll find the latest Auto-AI News and updates regarding features!\n"
            "If you don't wish to see this message, you can run Auto-AI with the *--skip-news* flag.\n"
        )
