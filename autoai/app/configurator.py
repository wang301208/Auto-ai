...
import click
from autoai.utils.ansi_colors import Back, Fore, Style

from autoai import utils
from autoai.config import Config
from autoai.config.config import GPT_3_MODEL, GPT_4_MODEL
from autoai.llm.api_manager import ApiManager
from autoai.logs import logger
from autoai.memory.vector import get_supported_memory_backends
...
def create_config(
    ...
    Args:
        ...
        allow_downloads (bool): Whether to allow Auto-AI to download files natively
    ...
    if allow_downloads:
        ...
        logger.typewriter_log(
            "WARNING: ",
            Fore.YELLOW,
            f"{Back.LIGHTYELLOW_EX}Auto-AI will now be able to download and save files to your machine.{Back.RESET} "
