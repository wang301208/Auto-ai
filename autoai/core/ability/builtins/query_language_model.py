...
from autoai.core.ability.base import Ability, AbilityConfiguration
from autoai.core.ability.schema import AbilityResult
from autoai.core.planning.simple import LanguageModelConfiguration
from autoai.core.plugin.simple import PluginLocation, PluginStorageFormat
...
class QueryLanguageModel(Ability):
    default_configuration = AbilityConfiguration(
        location=PluginLocation(
            ...
            storage_route="autoai.core.ability.builtins.QueryLanguageModel",
        ),
