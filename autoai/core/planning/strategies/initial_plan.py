...
from autoai.core.planning.base import PromptStrategy
...
from autoai.core.planning.strategies.utils import json_loads, to_numbered_list
...
class InitialPlan(PromptStrategy):
    ...
    def parse_response_content(
        ...
        parsed_response["task_list"] = [
            Task.parse_obj({**task, "type": TaskType(task["type"])})
            for task in parsed_response["task_list"]
        ]
