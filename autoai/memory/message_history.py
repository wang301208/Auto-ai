...
if TYPE_CHECKING:
    from autoai.agents import Agent, BaseAgent
    from autoai.config import Config

from autoai.json_utils.utilities import extract_dict_from_response
from autoai.llm.base import ChatSequence, Message
from autoai.llm.providers.openai import OPEN_AI_CHAT_MODELS
from autoai.llm.utils import (
    count_message_tokens,
    count_string_tokens,
    create_chat_completion,
)
from autoai.logs import (
