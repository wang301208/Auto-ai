...
from autoai.utils.stdlib_replacements import get_distro_name
import yaml
...
class AIConfig:
    ...
    def __init__(
        ...
        self.step_sequence = step_sequence or []
    ...
    def load(ai_settings_file: str | Path) -> "AIConfig":
        ...
        think_mode = config_params.get("think_mode")
        prompt_template = config_params.get("prompt_template")
        toolset = config_params.get("toolset", [])
        step_sequence = config_params.get("step_sequence", [])
    ...
    def construct_full_prompt(
        ...
        from autoai.prompts.prompt import build_default_prompt_generator
