...
from autoai.llm.providers.openai import _get_client

from autoai.llm.base import CompletionModelInfo
from autoai.logs import logger
from autoai.singleton import Singleton
...
class ApiManager(metaclass=Singleton):
    ...
    def get_models(self, **openai_credentials) -> List[Model]:
        ...
        if self.models is None:
            client = _get_client(openai_credentials)
