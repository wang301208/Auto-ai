...
BUILTIN_MODEL_SPECS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "prompt_token_cost_per_1k": 0.015,
        "completion_token_cost_per_1k": 0.06,
        "supports_streaming": True,
        "degradation_target": "gpt-4o",
    },
    {
        "model_id": "o1-mini",
        "provider_name": "openai",
        ...
        "completion_token_cost_per_1k": 0.012,
        "supports_streaming": True,
        "degradation_target": "gpt-4o-mini",
    },
    {
    ...
    },
    {
        ...
        "capabilities": ModelCapability.EMBEDDING.value,
        "max_context_tokens": 8192,
        "prompt_token_cost_per_1k": 0.00002,
    },
    {
    ...
    },
    {
        ...
        "max_context_tokens": 200000,
        "max_output_tokens": 8192,
        "prompt_token_cost_per_1k": 0.00025,
        "completion_token_cost_per_1k": 0.00125,
        "supports_functions": True,
        "supports_streaming": True,
        "degradation_target": "gpt-4o-mini",
    },
    {
        ...
        "completion_token_cost_per_1k": 0.0003,
        "supports_functions": True,
        "supports_streaming": True,
        "supports_vision": True,
    },
    {
        ...
        "tier": "smart",
        "capabilities": _caps(ModelCapability.CHAT, ModelCapability.FUNCTION_CALLING, ModelCapability.STREAMING, ModelCapability.VISION, ModelCapability.REASONING),
        "max_context_tokens": 2097152,
        "max_output_tokens": 8192,
        "prompt_token_cost_per_1k": 0.00125,
        "completion_token_cost_per_1k": 0.005,
        "supports_functions": True,
        "supports_streaming": True,
        "supports_vision": True,
        "degradation_target": "gemini-2.0-flash",
    },
    {
        "model_id": "qwen-max",
        ...
        "max_output_tokens": 8192,
        "prompt_token_cost_per_1k": 0.0028,
        "completion_token_cost_per_1k": 0.0084,
        "supports_functions": True,
        "supports_streaming": True,
        "degradation_target": "qwen-plus",
    },
    {
        "model_id": "qwen-plus",
        "provider_name": "aliyun",
        ...
        "completion_token_cost_per_1k": 0.0012,
        "supports_functions": True,
        "supports_streaming": True,
    },
    {
        ...
        "max_context_tokens": 131072,
        "max_output_tokens": 8192,
        "prompt_token_cost_per_1k": 0.00011,
        "completion_token_cost_per_1k": 0.00033,
        "supports_functions": True,
        "supports_streaming": True,
    },
    {
    ...
    },
    {
        ...
        "provider_name": "ollama",
        "display_name": "Mistral Small 24B (Local)",
        "tier": "balanced",
        "capabilities": _caps(ModelCapability.CHAT, ModelCapability.FUNCTION_CALLING, ModelCapability.STREAMING),
        "max_context_tokens": 32768,
        "max_output_tokens": 8192,
    ...
    },
    {
        ...
        "tier": "balanced",
        "capabilities": _caps(ModelCapability.CHAT, ModelCapability.COMPLETION, ModelCapability.STREAMING),
        "max_context_tokens": 16384,
        "max_output_tokens": 4096,
        "is_local": True,
        "supports_streaming": True,
    ...
    },
    {
        ...
        "max_context_tokens": 128000,
        "max_output_tokens": 4096,
        "prompt_token_cost_per_1k": 0.05,
        "completion_token_cost_per_1k": 0.05,
        "supports_functions": True,
        "supports_streaming": True,
    },
]
