...
agpt alphaevolve examples/circle_packing_with_artifacts/initial_program.py \
...
```bash
# Phase 1: Initial exploration
agpt alphaevolve examples/circle_packing/initial_program.py \
  examples/circle_packing/evaluator.py \
  --config examples/circle_packing/config_phase_1.yaml \
  --iterations 100

# Phase 2: Breaking through the plateau
agpt alphaevolve examples/circle_packing/openevolve_output/checkpoints/checkpoint_100/best_program.py \
  examples/circle_packing/evaluator.py \
