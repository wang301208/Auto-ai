...
```bash
# Basic run
agpt alphaevolve path/to/initial_program.py path/to/evaluator.py --config path/to/config.yaml --iterations 100

# Resume from checkpoint
agpt alphaevolve path/to/initial_program.py path/to/evaluator.py \
...
agpt alphaevolve initial_program.py evaluator.py --config config.yaml
```
...
agpt alphaevolve initial_program.py evaluator.py --config config_phase_1.yaml
```
...
agpt alphaevolve initial_program.rs evaluator.py --config config.yaml
```
...
agpt alphaevolve initial_prompt.txt evaluator.py --config config.yaml
```
...
agpt alphaevolve initial_program.r evaluator.py --config config.yaml
```
