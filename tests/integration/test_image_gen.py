...
from autoai.commands.image_gen import generate_image, generate_image_with_sd_webui
...
def test_huggingface_fail_request_with_delay_with_token(mocker, agent: Agent):
