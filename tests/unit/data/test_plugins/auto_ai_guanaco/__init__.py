"""This is the Test plugin for Auto-AI."""
...
try:
    ...
    warnings.warn(
        ...
        " Install it with 'pip install auto-ai-plugin-template' to run plugin"
        " tests."
    )
...
class AutoAIGuanaco(AutoAIPluginTemplate):
    """
    This is plugin for Auto-AI.
    """

    def __init__(self):
        super().__init__()
        self._name = "Auto-AI-Guanaco"
        self._version = "0.1.0"
