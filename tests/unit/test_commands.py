...
PARAMETERS = [
    ...
    CommandParameter("arg2", ParameterType.STRING, description="Argument 2", required=False),
]
...
def test_command_creation():
    ...
    assert (
        str(cmd)
        == "example: Example command, params: (arg1: number, arg2: Optional[string])"
    )
...
def test_get_command_prompt():
    ...
    assert f"(arg1: number, arg2: Optional[string])" in command_prompt
